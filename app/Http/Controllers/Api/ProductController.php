...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        try {
            ...
            $return = ['data' => ['mgs' => 'Produto criado com sucesso!']];
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            $return = ['data' => ['mgs' => 'Produto atualizado com sucesso!']];
            return response()->json($return, 201);
    ...
    public function delete(Product $id)
    {
        ...
        try {
            ...
            return  response()->json(ApiError::errorMessage('Houve um erro ao realizar a operação', 1012), 500);
        }
    }
}
